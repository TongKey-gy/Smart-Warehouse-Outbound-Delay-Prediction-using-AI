...
| 167 | submission_167.csv | submission_adaptive_fast_gkf_23_20260404_190635.csv | 2026-04-04 19:06:35 | adaptive_fast_gkf_23 | 9.155445 | delay_risk와 workload를 결합하고 보조 모델도 약하게 가중해 분산과 tail bias를 동시에 줄인다. | blend_secondary_model weight=0.22 secondary_use_layout_id=True secondary_target_weight_mode=log |
| 168 | submission_168.csv | submission_adaptive_fast_gkf_24_20260404_191304.csv | 2026-04-04 19:13:04 | adaptive_fast_gkf_24 | 10.037827 | 복잡한 상호작용을 더 담기 위해 트리 용량을 늘리고, congestion 피처를 추가한다. |
| 169 | submission_169.csv | submission_adaptive_fast_gkf_23_20260404_191341.csv | 2026-04-04 19:13:41 | adaptive_fast_gkf_23 | 9.885561 | 시간대 패턴과 약한 정규화를 통해 고지연 샘플 분리를 더 세밀하게 시도한다. | blend_secondary_model weight=0.25 secondary_use_layout_id=True secondary_target_weight_mode=none |
| 170 | submission_170.csv | submission_adaptive_temporal_mix_01_20260404_215257.csv | 2026-04-04 21:52:57 | adaptive_temporal_mix_01 | 9.116417 | `adaptive_gkf_01` 본체를 기준으로 유지하고 보조 모델에만 temporal을 얹어 실효 temporal 비중을 `0.08`로 조정한다. secondary_use_layout_id=True, secondary_target_weight_mode=none로 과적합 여부를 함께 확인한다. | blend_secondary_model weight=0.08 secondary_use_layout_id=True secondary_target_weight_mode=none |
| 171 | submission_171.csv | submission_adaptive_temporal_mix_02_20260404_215529.csv | 2026-04-04 21:55:29 | adaptive_temporal_mix_02 | 9.119796 | `adaptive_gkf_01` 본체를 기준으로 유지하고 보조 모델에만 temporal을 얹어 실효 temporal 비중을 `0.04`로 조정한다. secondary_use_layout_id=True, secondary_target_weight_mode=none로 과적합 여부를 함께 확인한다. | blend_secondary_model weight=0.04 secondary_use_layout_id=True secondary_target_weight_mode=none |
| 172 | submission_172.csv | submission_adaptive_temporal_mix_03_20260404_215801.csv | 2026-04-04 21:58:01 | adaptive_temporal_mix_03 | 9.118922 | `adaptive_gkf_01` 본체를 기준으로 유지하고 보조 모델에만 temporal을 얹어 실효 temporal 비중을 `0.05`로 조정한다. secondary_use_layout_id=True, secondary_target_weight_mode=none로 과적합 여부를 함께 확인한다. | blend_secondary_model weight=0.05 secondary_use_layout_id=True secondary_target_weight_mode=none |
| 173 | submission_173.csv | submission_adaptive_temporal_mix_04_20260404_220041.csv | 2026-04-04 22:00:41 | adaptive_temporal_mix_04 | 9.117595 | `adaptive_gkf_01` 본체를 기준으로 유지하고 보조 모델에만 temporal을 얹어 실효 temporal 비중을 `0.08`로 조정한다. secondary_use_layout_id=True, secondary_target_weight_mode=log로 과적합 여부를 함께 확인한다. | blend_secondary_model weight=0.08 secondary_use_layout_id=True secondary_target_weight_mode=log |
| 174 | submission_174.csv | submission_adaptive_temporal_mix_05_20260404_220310.csv | 2026-04-04 22:03:10 | adaptive_temporal_mix_05 | 9.146822 | `adaptive_gkf_01` 본체를 기준으로 유지하고 주 모델에만 temporal을 얹어 실효 temporal 비중을 `0.04`로 조정한다. secondary_use_layout_id=True, secondary_target_weight_mode=none로 과적합 여부를 함께 확인한다. | blend_secondary_model weight=0.96 secondary_use_layout_id=True secondary_target_weight_mode=none |
| 175 | submission_175.csv | submission_adaptive_temporal_mix_06_20260404_220543.csv | 2026-04-04 22:05:43 | adaptive_temporal_mix_06 | 9.145492 | `adaptive_gkf_01` 본체를 기준으로 유지하고 주 모델에만 temporal을 얹어 실효 temporal 비중을 `0.05`로 조정한다. secondary_use_layout_id=True, secondary_target_weight_mode=none로 과적합 여부를 함께 확인한다. | blend_secondary_model weight=0.95 secondary_use_layout_id=True secondary_target_weight_mode=none |
| 176 | submission_176.csv | submission_adaptive_temporal_mix_07_20260404_220811.csv | 2026-04-04 22:08:11 | adaptive_temporal_mix_07 | 9.140590 | `adaptive_gkf_01` 본체를 기준으로 유지하고 주 모델에만 temporal을 얹어 실효 temporal 비중을 `0.08`로 조정한다. secondary_use_layout_id=True, secondary_target_weight_mode=none로 과적합 여부를 함께 확인한다. | blend_secondary_model weight=0.92 secondary_use_layout_id=True secondary_target_weight_mode=none |
| 177 | submission_177.csv | submission_adaptive_temporal_mix_08_20260404_221039.csv | 2026-04-04 22:10:39 | adaptive_temporal_mix_08 | 9.138009 | `adaptive_gkf_01` 본체를 기준으로 유지하고 주 모델에만 temporal을 얹어 실효 temporal 비중을 `0.11`로 조정한다. secondary_use_layout_id=True, secondary_target_weight_mode=none로 과적합 여부를 함께 확인한다. | blend_secondary_model weight=0.89 secondary_use_layout_id=True secondary_target_weight_mode=none |
| 178 | submission_178.csv | submission_adaptive_temporal_mix_09_20260404_221313.csv | 2026-04-04 22:13:13 | adaptive_temporal_mix_09 | 9.118080 | `adaptive_gkf_01` 본체를 기준으로 유지하고 보조 모델에만 temporal을 얹어 실효 temporal 비중을 `0.11`로 조정한다. secondary_use_layout_id=True, secondary_target_weight_mode=none로 과적합 여부를 함께 확인한다. | blend_secondary_model weight=0.11 secondary_use_layout_id=True secondary_target_weight_mode=none |
| 179 | submission_179.csv | submission_adaptive_temporal_mix_10_20260404_221541.csv | 2026-04-04 22:15:41 | adaptive_temporal_mix_10 | 9.118862 | `adaptive_gkf_01` 본체를 기준으로 유지하고 보조 모델에만 temporal을 얹어 실효 temporal 비중을 `0.05`로 조정한다. secondary_use_layout_id=False, secondary_target_weight_mode=none로 과적합 여부를 함께 확인한다. | blend_secondary_model weight=0.05 secondary_use_layout_id=False secondary_target_weight_mode=none |
| 180 | submission_180.csv | submission_adaptive_congestion_mix_01_20260404_222520.csv | 2026-04-04 22:25:20 | adaptive_congestion_mix_01 | 9.110871 | `adaptive_gkf_01` 블렌드는 유지한 채 주모델에만 congestion을 추가하고 `num_leaves=111`, `min_child_samples=24`, `target_weight_strength=0.32`로 복잡도를 낮춘다. secondary_weight=0.25, secondary_use_layout_id=True로 과적합 완화를 함께 확인한다. | blend_secondary_model weight=0.25 secondary_use_layout_id=True secondary_target_weight_mode=none |
| 181 | submission_181.csv | submission_adaptive_congestion_mix_02_20260404_222743.csv | 2026-04-04 22:27:43 | adaptive_congestion_mix_02 | 9.109979 | `adaptive_gkf_01` 블렌드는 유지한 채 주모델에만 congestion을 추가하고 `num_leaves=95`, `min_child_samples=26`, `target_weight_strength=0.30`로 복잡도를 낮춘다. secondary_weight=0.25, secondary_use_layout_id=True로 과적합 완화를 함께 확인한다. | blend_secondary_model weight=0.25 secondary_use_layout_id=True secondary_target_weight_mode=none |
| 182 | submission_182.csv | submission_adaptive_congestion_mix_03_20260404_223006.csv | 2026-04-04 22:30:06 | adaptive_congestion_mix_03 | 9.114210 | `adaptive_gkf_01` 블렌드는 유지한 채 주모델에만 congestion을 추가하고 `num_leaves=95`, `min_child_samples=28`, `target_weight_strength=0.28`로 복잡도를 낮춘다. secondary_weight=0.25, secondary_use_layout_id=True로 과적합 완화를 함께 확인한다. | blend_secondary_model weight=0.25 secondary_use_layout_id=True secondary_target_weight_mode=none |
| 183 | submission_183.csv | submission_adaptive_congestion_mix_04_20260404_223229.csv | 2026-04-04 22:32:29 | adaptive_congestion_mix_04 | 9.107735 | `adaptive_gkf_01` 블렌드는 유지한 채 주모델에만 congestion을 추가하고 `num_leaves=95`, `min_child_samples=28`, `target_weight_strength=0.30`로 복잡도를 낮춘다. secondary_weight=0.22, secondary_use_layout_id=True로 과적합 완화를 함께 확인한다. | blend_secondary_model weight=0.22 secondary_use_layout_id=True secondary_target_weight_mode=none |
| 184 | submission_184.csv | submission_adaptive_congestion_mix_05_20260404_223448.csv | 2026-04-04 22:34:48 | adaptive_congestion_mix_05 | 9.111082 | `adaptive_gkf_01` 블렌드는 유지한 채 주모델에만 congestion을 추가하고 `num_leaves=95`, `min_child_samples=30`, `target_weight_strength=0.28`로 복잡도를 낮춘다. secondary_weight=0.22, secondary_use_layout_id=True로 과적합 완화를 함께 확인한다. | blend_secondary_model weight=0.22 secondary_use_layout_id=True secondary_target_weight_mode=none |
| 185 | submission_185.csv | submission_adaptive_congestion_mix_06_20260404_223709.csv | 2026-04-04 22:37:09 | adaptive_congestion_mix_06 | 9.113258 | `adaptive_gkf_01` 블렌드는 유지한 채 주모델에만 congestion을 추가하고 `num_leaves=95`, `min_child_samples=30`, `target_weight_strength=0.30`로 복잡도를 낮춘다. secondary_weight=0.20, secondary_use_layout_id=True로 과적합 완화를 함께 확인한다. | blend_secondary_model weight=0.20 secondary_use_layout_id=True secondary_target_weight_mode=none |
| 186 | submission_186.csv | submission_adaptive_congestion_mix_07_20260404_223937.csv | 2026-04-04 22:39:37 | adaptive_congestion_mix_07 | 9.110198 | `adaptive_gkf_01` 블렌드는 유지한 채 주모델에만 congestion을 추가하고 `num_leaves=111`, `min_child_samples=26`, `target_weight_strength=0.32`로 복잡도를 낮춘다. secondary_weight=0.22, secondary_use_layout_id=True로 과적합 완화를 함께 확인한다. | blend_secondary_model weight=0.22 secondary_use_layout_id=True secondary_target_weight_mode=none |
| 187 | submission_187.csv | submission_adaptive_congestion_mix_08_20260404_224201.csv | 2026-04-04 22:42:01 | adaptive_congestion_mix_08 | 9.108131 | `adaptive_gkf_01` 블렌드는 유지한 채 주모델에만 congestion을 추가하고 `num_leaves=95`, `min_child_samples=28`, `target_weight_strength=0.30`로 복잡도를 낮춘다. secondary_weight=0.22, secondary_use_layout_id=False로 과적합 완화를 함께 확인한다. | blend_secondary_model weight=0.22 secondary_use_layout_id=False secondary_target_weight_mode=none |
| 188 | submission_188.csv | submission_adaptive_congestion_mix_09_20260404_224435.csv | 2026-04-04 22:44:35 | adaptive_congestion_mix_09 | 9.110202 | `adaptive_gkf_01` 블렌드는 유지한 채 주모델에만 congestion을 추가하고 `num_leaves=95`, `min_child_samples=28`, `target_weight_strength=0.30`로 복잡도를 낮춘다. secondary_weight=0.20, secondary_use_layout_id=True로 과적합 완화를 함께 확인한다. | blend_secondary_model weight=0.20 secondary_use_layout_id=True secondary_target_weight_mode=log |
| 189 | submission_189.csv | submission_adaptive_congestion_mix_10_20260404_224708.csv | 2026-04-04 22:47:08 | adaptive_congestion_mix_10 | 9.113650 | `adaptive_gkf_01` 블렌드는 유지한 채 주모델에만 congestion을 추가하고 `num_leaves=95`, `min_child_samples=28`, `target_weight_strength=0.30`로 복잡도를 낮춘다. secondary_weight=0.22, secondary_use_layout_id=True로 과적합 완화를 함께 확인한다. | blend_secondary_model weight=0.22 secondary_use_layout_id=True secondary_target_weight_mode=none |
| 190 | submission_190.csv | submission_adaptive_congestion_followup_01_20260404_225205.csv | 2026-04-04 22:52:05 | adaptive_congestion_followup_01 | 9.111213 | 최고점 `mix_04` 주변에서 secondary_weight만 `0.23`으로 한 칸 올려 블렌드 균형을 미세 조정한다. | blend_secondary_model weight=0.23 secondary_use_layout_id=True secondary_target_weight_mode=none |
| 191 | submission_191.csv | submission_adaptive_congestion_followup_02_20260404_225430.csv | 2026-04-04 22:54:30 | adaptive_congestion_followup_02 | 9.114007 | 첫 결과를 보고 congestion 규제를 아주 조금만 풀기 위해 `target_weight_strength=0.31`로 올린다. | blend_secondary_model weight=0.22 secondary_use_layout_id=True secondary_target_weight_mode=none |
| 192 | submission_192.csv | submission_adaptive_congestion_followup_03_20260404_225702.csv | 2026-04-04 22:57:02 | adaptive_congestion_followup_03 | 9.111190 | 직전 개선이 있으면 보조모델에 아주 약한 log weighting을 더해 tail 보정을 미세하게 확인한다. | blend_secondary_model weight=0.22 secondary_use_layout_id=True secondary_target_weight_mode=log |
| 193 | submission_193.csv | submission_adaptive_gkf_tuning_01_20260404_230540.csv | 2026-04-04 23:05:40 | adaptive_gkf_tuning_01 | 9.112414 | baseline보다 보조모델 비중과 타깃 가중을 동시에 한 단계 낮춰 과적합을 줄인다. | blend_secondary_model weight=0.22 secondary_use_layout_id=True secondary_target_weight_mode=none |
| 194 | submission_194.csv | submission_adaptive_gkf_tuning_02_20260404_230811.csv | 2026-04-04 23:08:11 | adaptive_gkf_tuning_02 | 9.113309 | 직전 결과를 보고 secondary_weight를 더 낮춰 주모델 anchor를 더 강하게 유지한다. | blend_secondary_model weight=0.20 secondary_use_layout_id=True secondary_target_weight_mode=none |
| 195 | submission_195.csv | submission_adaptive_gkf_tuning_03_20260404_231040.csv | 2026-04-04 23:10:40 | adaptive_gkf_tuning_03 | 9.109522 | target_weight_strength를 더 낮춰 tail overweight가 과했는지 확인한다. | blend_secondary_model weight=0.22 secondary_use_layout_id=True secondary_target_weight_mode=none |
| 196 | submission_196.csv | submission_adaptive_gkf_tuning_04_20260404_231311.csv | 2026-04-04 23:13:11 | adaptive_gkf_tuning_04 | 9.109791 | 반대로 보조모델 비중을 높여 blend 다양성이 도움이 되는지 확인한다. | blend_secondary_model weight=0.30 secondary_use_layout_id=True secondary_target_weight_mode=none |
| 197 | submission_197.csv | submission_adaptive_gkf_tuning_05_20260404_231542.csv | 2026-04-04 23:15:42 | adaptive_gkf_tuning_05 | 9.108616 | tail residual을 더 줄일 여지가 있는지 higher target weighting을 재확인한다. | blend_secondary_model weight=0.22 secondary_use_layout_id=True secondary_target_weight_mode=none |
| 198 | submission_198.csv | submission_adaptive_gkf_tuning_06_20260404_231814.csv | 2026-04-04 23:18:14 | adaptive_gkf_tuning_06 | 9.113198 | 현재 최고 설정 근처에서 target weighting만 0.32로 절충한다. | blend_secondary_model weight=0.22 secondary_use_layout_id=True secondary_target_weight_mode=none |
| 199 | submission_199.csv | submission_adaptive_gkf_tuning_07_20260404_232044.csv | 2026-04-04 23:20:44 | adaptive_gkf_tuning_07 | 9.110109 | 두 축을 동시에 낮춘 가장 보수적 조합으로 분산 축소를 확인한다. | blend_secondary_model weight=0.20 secondary_use_layout_id=True secondary_target_weight_mode=none |
| 200 | submission_200.csv | submission_adaptive_gkf_tuning_08_20260404_232312.csv | 2026-04-04 23:23:12 | adaptive_gkf_tuning_08 | 9.111742 | 보조모델의 layout_id 의존을 제거해 generalization을 점검한다. | blend_secondary_model weight=0.22 secondary_use_layout_id=False secondary_target_weight_mode=none |
| 201 | submission_201.csv | submission_adaptive_gkf_tuning_09_20260404_232551.csv | 2026-04-04 23:25:51 | adaptive_gkf_tuning_09 | 9.113235 | 보조모델에만 아주 약한 log weighting을 넣어 tail 보정을 미세하게 확인한다. | blend_secondary_model weight=0.22 secondary_use_layout_id=True secondary_target_weight_mode=log |
| 202 | submission_202.csv | submission_adaptive_gkf_tuning_10_20260404_232823.csv | 2026-04-04 23:28:23 | adaptive_gkf_tuning_10 | 9.108616 | 현재 최고 설정을 마지막으로 한 번 더 좁게 재확인한다. | blend_secondary_model weight=0.22 secondary_use_layout_id=True secondary_target_weight_mode=none |
| 203 | submission_203.csv | submission_adaptive_delay_risk_01_20260404_234509.csv | 2026-04-04 23:45:09 | adaptive_delay_risk_01 | 9.111557 | flow/backlog 계열 delay-risk만 먼저 추가해 가장 보수적인 확장을 확인한다. | blend_secondary_model weight=0.25 secondary_use_layout_id=True secondary_target_weight_mode=none |
| 204 | submission_204.csv | submission_adaptive_delay_risk_01_20260404_234614.csv | 2026-04-04 23:46:14 | adaptive_delay_risk_01 | 9.111557 | flow/backlog 계열 delay-risk만 먼저 추가해 가장 보수적인 확장을 확인한다. | blend_secondary_model weight=0.25 secondary_use_layout_id=True secondary_target_weight_mode=none |
| 205 | submission_205.csv | submission_adaptive_delay_risk_02_20260404_234925.csv | 2026-04-04 23:49:25 | adaptive_delay_risk_02 | 9.113835 | queue/energy 계열 delay-risk로 병목 대기 신호가 더 직접적으로 먹히는지 본다. | blend_secondary_model weight=0.25 secondary_use_layout_id=True secondary_target_weight_mode=none |
| 206 | submission_206.csv | submission_adaptive_delay_risk_03_20260404_235155.csv | 2026-04-04 23:51:55 | adaptive_delay_risk_03 | 9.111397 | movement friction 계열을 추가하고 weighting을 조금 높여 tail 과소예측을 줄이는지 본다. | blend_secondary_model weight=0.22 secondary_use_layout_id=True secondary_target_weight_mode=none |
| 207 | submission_207.csv | submission_adaptive_delay_risk_04_20260404_235436.csv | 2026-04-04 23:54:36 | adaptive_delay_risk_04 | 9.111411 | flow+queue+motion을 함께 넣은 hybrid risk set으로 상호보완 여부를 확인한다. | blend_secondary_model weight=0.22 secondary_use_layout_id=True secondary_target_weight_mode=none |
| 208 | submission_208.csv | submission_adaptive_delay_risk_05_20260404_235708.csv | 2026-04-04 23:57:08 | adaptive_delay_risk_05 | 9.115834 | 현재까지 나은 방향이면 flow 확장에 stronger weighting을 얹어 tail 개선 폭을 본다. | blend_secondary_model weight=0.22 secondary_use_layout_id=True secondary_target_weight_mode=none |
| 209 | submission_209.csv | submission_adaptive_delay_risk_06_20260404_235937.csv | 2026-04-04 23:59:37 | adaptive_delay_risk_06 | 9.108772 | storage 접근 리스크 축이 별도 신호를 주는지 분리 확인한다. | blend_secondary_model weight=0.25 secondary_use_layout_id=True secondary_target_weight_mode=none |
| 210 | submission_210.csv | submission_adaptive_delay_risk_07_20260405_000215.csv | 2026-04-05 00:02:15 | adaptive_delay_risk_07 | 9.114445 | hybrid risk set에서 secondary 비중을 줄여 주모델 확장 효과만 더 선명하게 본다. | blend_secondary_model weight=0.20 secondary_use_layout_id=True secondary_target_weight_mode=none |
| 211 | submission_211.csv | submission_adaptive_delay_risk_08_20260405_000445.csv | 2026-04-05 00:04:45 | adaptive_delay_risk_08 | 9.115223 | 보조모델 layout_id 의존을 제거해 risk feature 일반화가 더 좋아지는지 본다. | blend_secondary_model weight=0.22 secondary_use_layout_id=False secondary_target_weight_mode=none |
| 212 | submission_212.csv | submission_adaptive_delay_risk_09_20260405_000725.csv | 2026-04-05 00:07:25 | adaptive_delay_risk_09 | 9.116918 | 보조모델에 아주 약한 log weighting을 넣어 risk 확장과 tail 보정을 결합한다. | blend_secondary_model weight=0.22 secondary_use_layout_id=True secondary_target_weight_mode=log |
| 213 | submission_213.csv | submission_adaptive_delay_risk_10_20260405_001001.csv | 2026-04-05 00:10:01 | adaptive_delay_risk_10 | 9.113585 | 마지막으로 보조모델에도 같은 flow risk를 얕게 공유해 진짜 역할 분리가 필요한지 확인한다. | blend_secondary_model weight=0.25 secondary_use_layout_id=True secondary_target_weight_mode=none |
| 214 | submission_214.csv | submission_adaptive_layout80_01_20260405_002147.csv | 2026-04-05 00:21:47 | adaptive_layout80_01 | 9.114267 | submission_80의 구조를 유지한 채 flow/layout 상호작용만 먼저 추가해 가장 직접적인 레이아웃 효과를 본다. | blend_secondary_model weight=0.35 secondary_use_layout_id=True secondary_target_weight_mode=none |
| 215 | submission_215.csv | submission_adaptive_layout80_02_20260405_002406.csv | 2026-04-05 00:24:06 | adaptive_layout80_02 | 9.115085 | 통로 폭과 교차점 대기 중심의 path interaction으로 실제 동선 병목을 더 직접 반영한다. | blend_secondary_model weight=0.35 secondary_use_layout_id=True secondary_target_weight_mode=none |
| 216 | submission_216.csv | submission_adaptive_layout80_03_20260405_002623.csv | 2026-04-05 00:26:23 | adaptive_layout80_03 | 9.112875 | 면적 대비 robot/pack/storage 밀도 축이 더 유효한지 분리 확인한다. | blend_secondary_model weight=0.35 secondary_use_layout_id=True secondary_target_weight_mode=none |
| 217 | submission_217.csv | submission_adaptive_layout80_04_20260405_002841.csv | 2026-04-05 00:28:41 | adaptive_layout80_04 | 9.111852 | 현재까지 나은 layout 축들을 합치고 secondary 비중을 소폭 줄여 주모델 신호를 살린다. | blend_secondary_model weight=0.30 secondary_use_layout_id=True secondary_target_weight_mode=none |
| 218 | submission_218.csv | submission_adaptive_layout80_05_20260405_003106.csv | 2026-04-05 00:31:06 | adaptive_layout80_05 | 9.111101 | 현재 최고 layout 축에서 주모델 `layout_id`만 추가해 레이아웃 구분력의 실효성을 확인한다. | blend_secondary_model weight=0.28 secondary_use_layout_id=True secondary_target_weight_mode=none |
| 219 | submission_219.csv | submission_adaptive_layout80_06_20260405_003330.csv | 2026-04-05 00:33:30 | adaptive_layout80_06 | 9.108352 | 밀도 축이 나쁘지 않다면 secondary에도 같은 density layout set을 공유해 layout bias를 보강한다. | blend_secondary_model weight=0.25 secondary_use_layout_id=True secondary_target_weight_mode=none |
| 220 | submission_220.csv | submission_adaptive_layout80_07_20260405_003601.csv | 2026-04-05 00:36:01 | adaptive_layout80_07 | 9.114049 | layout 효과가 어느 정도 확인되면 storage 계열 delay_risk를 얇게 섞어 layout-driven access risk를 보강한다. | blend_secondary_model weight=0.25 secondary_use_layout_id=True secondary_target_weight_mode=none |
| 221 | submission_221.csv | submission_adaptive_layout80_08_20260405_003831.csv | 2026-04-05 00:38:31 | adaptive_layout80_08 | 9.113271 | secondary layout_id 의존을 제거해 path interaction의 일반화가 좋아지는지 본다. | blend_secondary_model weight=0.22 secondary_use_layout_id=False secondary_target_weight_mode=none |
| 222 | submission_222.csv | submission_adaptive_layout80_09_20260405_004124.csv | 2026-04-05 00:41:24 | adaptive_layout80_09 | 9.113797 | 가장 layout-heavy한 조합에서 secondary에만 아주 약한 weighting과 layout set 공유를 더한다. | blend_secondary_model weight=0.22 secondary_use_layout_id=True secondary_target_weight_mode=log |
| 223 | submission_223.csv | submission_adaptive_layout80_10_20260405_004443.csv | 2026-04-05 00:44:43 | adaptive_layout80_10 | 9.115115 | 현재 최고 조합을 더 촘촘한 fold로 다시 확인해 layout 신호의 안정성을 본다. | blend_secondary_model weight=0.25 secondary_use_layout_id=True secondary_target_weight_mode=none |
| 224 | submission_224.csv | submission_default_groupkfold_bottleneck_blend_v1_20260405_134744.csv | 2026-04-05 13:47:44 | default_groupkfold_bottleneck_blend_v1 | 9.113586 | - | blend_secondary_model weight=0.35 secondary_use_layout_id=True secondary_target_weight_mode=none |
| 225 | submission_225.csv | submission_notebook_port_seen_tune_01_20260405_135855.csv | 2026-04-05 13:58:55 | notebook_port_seen_tune_01 | 9.111699 | - | blend_secondary_model weight=0.22 secondary_use_layout_id=True secondary_target_weight_mode=none |
| 226 | submission_226.csv | submission_notebook_port_seen_tune_02_20260405_135859.csv | 2026-04-05 13:58:59 | notebook_port_seen_tune_02 | 9.116606 | - | blend_secondary_model weight=0.18 secondary_use_layout_id=True secondary_target_weight_mode=none |
| 227 | submission_227.csv | submission_notebook_port_seen_tune_03_20260405_141111.csv | 2026-04-05 14:11:11 | notebook_port_seen_tune_03 | 9.107349 | - | blend_secondary_model weight=0.30 secondary_use_layout_id=True secondary_target_weight_mode=none |
| 228 | submission_228.csv | submission_notebook_port_seen_tune_04_20260405_141115.csv | 2026-04-05 14:11:15 | notebook_port_seen_tune_04 | 9.106705 | - | blend_secondary_model weight=0.30 secondary_use_layout_id=True secondary_target_weight_mode=none |
| 229 | submission_229.csv | submission_notebook_port_group_mass_20260405_143158.csv | 2026-04-05 14:31:58 | notebook_port_group_mass | 9.113799 | - | blend_secondary_model weight=0.30 secondary_use_layout_id=True secondary_target_weight_mode=none |
| 230 | submission_230.csv | submission_notebook_port_group_battery_20260405_143219.csv | 2026-04-05 14:32:19 | notebook_port_group_battery | 9.110398 | - | blend_secondary_model weight=0.30 secondary_use_layout_id=True secondary_target_weight_mode=none |
| 231 | submission_231.csv | submission_notebook_port_group_flow_20260405_143220.csv | 2026-04-05 14:32:20 | notebook_port_group_flow | 9.110684 | - | blend_secondary_model weight=0.30 secondary_use_layout_id=True secondary_target_weight_mode=none |
| 232 | submission_232.csv | submission_no_port_no_secondary_layout_20260405_144152.csv | 2026-04-05 14:41:52 | no_port_no_secondary_layout | 9.110169 | - | blend_secondary_model weight=0.30 secondary_use_layout_id=False secondary_target_weight_mode=none |
| 233 | submission_233.csv | submission_notebook_battery_no_secondary_layout_20260405_144205.csv | 2026-04-05 14:42:05 | notebook_battery_no_secondary_layout | 9.110011 | - | blend_secondary_model weight=0.30 secondary_use_layout_id=False secondary_target_weight_mode=none |
<!-- EXPERIMENT_LOG_END -->
