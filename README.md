...
본 데이터는 **AMR(Autonomous Mobile Robot) 기반 스마트 물류창고 시뮬레이션 환경**에서 생성되었으며, 각 행은 특정 시나리오의 특정 시점에서 관측된 창고 운영 상태 스냅샷을 의미합니다.  
예측 과제는 현재 시점의 운영 상태를 바탕으로 **향후 30분 평균 출고 지연 시간**을 추정하는 회귀 문제입니다.
...
### ⚠️ Data Leakage & Validation Notes
